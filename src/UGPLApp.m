classdef UGPLApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            UGPLApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'A2Gmod')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong A2Gmod
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'A2Gmod').getString, ...
